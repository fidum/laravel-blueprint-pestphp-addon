...
use App\Http\Requests\ScreeningQuestionStoreRequest;
use App\Http\Requests\ScreeningQuestionUpdateRequest;
use App\QuestionType;
use App\Screening\Report;
use App\Screening\ScreeningQuestion;

it('displays view on index', function () {
    $screeningQuestions = ScreeningQuestion::factory()->times(3)->create();
...
it('saves and redirects on store', function () {
    ...
    $question_type = QuestionType::factory()->create();
